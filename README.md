...
This is a simple script to download all [NWB](https://www.mein-bus.net) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
